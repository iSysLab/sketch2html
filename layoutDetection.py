...
class Html:
    ...
    def pxMapping(self, length, threshold):  # to button, edittext
    ...
    def objectAppendStack(self, detectedObjects):
        ...
        for item in detectedObjects[0][1][0]:
            ...
            for layoutItem in self.divList:
                ...
                lx1, ly1, lx2, ly2 = int(layoutItem[1][0]), int(layoutItem[1][1]), int(layoutItem[1][2]), int(
                    layoutItem[1][3])
                ...
                if ox1 > lx1 and oy1 > ly1 and ox2 < lx2 and oy2 < ly2:
                    if item[0] == "radioButtonV" or item[0] == "checkBoxV" or item[0] == "radioButtonH" or item[
                        0] == "checkBoxH":  # v
            ...
            for i, stackItem in enumerate(self.htmlStack):
                ...
                if layoutObject[0] == stackTypeAndId and layoutObject[2] != None:
                    ...
                    if layoutObject[1].lower() == "button":
                        ...
                        self.addCssList(
                            "#" + str(layoutObject[1]) + str(self.objectNum[str(layoutObject[1])]) + ":focus",
        ...
        for i, row in enumerate(madeRows):
            ...
            if len(inCols) == 0:
                if (self.preventOverlap([[rectx1, recty1, rectx2, recty2]]) == True):
                    ...
                    cv2.putText(img, "div" + str(self.objectNum["div"]), (int(rectx1) + 10, int(recty1) + 20),
                    ...
                    html.addDivList(id="#div" + str(self.objectNum["div"]),
                                    width=html.mappingP(rectx2 - rectx1, width, False),
                    ...
                    if rowGaps != []:
                        ...
                        if flag2 == True:
                            if lastDiv == self.objectNum["div"] - 1:
                                ...
                                html.addDivList(id="#div" + str(lastDiv),
                                                width=html.mappingP(rx1 - lx1, width, False),
                                                height=html.mappingP(height, False, height),
                                                etc=[{"float": "left"}])  # super layout
